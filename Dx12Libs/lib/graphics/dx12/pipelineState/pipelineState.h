...
namespace ym
{
	...
	public:
		...
		void AddLocalRootSignatureAndExportAssociation(ym::RootSignature &localRootSig, LPCWSTR *exportsArray, UINT exportsCount)
		{
		...
		void AddGlobalRootSignature(ym::RootSignature &localRootSig)
		{
