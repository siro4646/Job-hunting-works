...
namespace ym
{
	...
	bool CreateRaytracingRootSignature(
		ym::Device *pDevice,
		ym::u32 asCount,
		ym::u32 globalCbvCount,
		ym::u32 globalSrvCount,
		ym::u32 globalUavCount,
		ym::u32 globalSamplerCount,
		ym::RootSignature *pGlobalRS,
		ym::RootSignature *pLocalRS)
	{
		...
		localCount.cbv = ym::kCbvMax - globalCbvCount;
		localCount.srv = ym::kSrvMax - globalSrvCount - asCount;
		localCount.uav = ym::kUavMax - globalUavCount;
		localCount.sampler = ym::kSamplerMax - globalSamplerCount;
