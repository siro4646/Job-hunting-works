...
namespace ym
{
	...
	public:
		...
		bool InitializeFromDDS(Device *pDev, CommandList *pCmdList, const void *pDdsBin, size_t size, ym::u32 mipLevels, bool isForceSRGB, bool forceSysRam = false);
		bool InitializeFromTGA(Device *pDev, CommandList *pCmdList, const void *pTgaBin, size_t size, ym::u32 mipLevels, bool isForceSRGB, bool forceSysRam = false);
		bool InitializeFromPNG(Device *pDev, CommandList *pCmdList, const void *pPngBin, size_t size, ym::u32 mipLevels, bool isForceSRGB, bool forceSysRam = false);
		bool InitializeFromEXR(Device *pDev, CommandList *pCmdList, const void *pPngBin, size_t size, ym::u32 mipLevels, bool forceSysRam = false);
		bool InitializeFromHDR(Device *pDev, CommandList *pCmdList, const void *pTgaBin, size_t size, ym::u32 mipLevels, bool forceSysRam = false);
		...
		std::unique_ptr<DirectX::ScratchImage> InitializeFromEXRwoLoad(Device *pDev, const void *pPngBin, size_t size, ym::u32 mipLevels);
		std::unique_ptr<DirectX::ScratchImage> InitializeFromHDRwoLoad(Device *pDev, const void *pTgaBin, size_t size, ym::u32 mipLevels);
