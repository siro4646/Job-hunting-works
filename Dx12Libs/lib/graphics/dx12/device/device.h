...
namespace ym
{
	...
	public:
		...
		bool Initialize(HWND hWnd, UINT screenWidth, u32 screenHeight, const std::array<u32, D3D12_DESCRIPTOR_HEAP_TYPE_NUM_TYPES> &numDescs, ColorSpaceType csType = ColorSpaceType::Rec709);
		void Destroy();
